function mol_updated = mutation_mol_3ed( mol )
...
addition_choices_updated=mol_updated((find(mol_updated(:,5)<3 & mol_updated(:,14)<79 )),:) %exclude atoms of 3 connections and oxygen atoms also
