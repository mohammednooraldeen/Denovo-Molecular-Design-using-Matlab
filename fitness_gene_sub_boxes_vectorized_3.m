function f = fitness_gene_sub_boxes_vectorized_3( chromosome, C,N,O,H,e,P_C,P_O,P_N,keep_original_charge)
...
f(i,1)=eval_xyz_sub_surfaces_4(mol,'C',C,N,O,H,e,P_C,P_O,P_N,keep_original_charge);
